...
#
# Documented release: v1.5.0 (see CHANGELOG.md / Git tag). Deployed code follows BRANCH.
...
#
# Optional env:
#   BRANCH=main PORT=3000 APP_DIR=/opt/cp_migration_tool SERVICE_NAME=cp-migration-tool DOC_RELEASE_TAG=v1.5.0
# =============================================================================
set -euo pipefail

DOC_RELEASE_TAG="${DOC_RELEASE_TAG:-v1.5.0}"
...
# Branch: origin/<name> or tag ref after fetch (e.g. v1.5.0).

...
#
# Examples:
#   REMOTE=ubuntu@vm ./deploy/upgrade-remote-production.sh v1.5.1
#   REMOTE=ubuntu@vm DOC_RELEASE_TAG=v1.5.1 ./deploy/upgrade-remote-production.sh main
#
# Override repo (forks):
#   REPO_SLUG=org/CP_Migration_Tool REMOTE=user@host ./deploy/upgrade-remote-production.sh v1.5.1
# =============================================================================
set -euo pipefail
